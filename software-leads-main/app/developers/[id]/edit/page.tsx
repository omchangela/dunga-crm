...
export default function EditDeveloperPage() {
  ...
  if (!dev) return <div className="flex items-center justify-center py-20 text-xs font-bold text-slate-400">Loading profile...</div>;
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="mx-auto flex max-w-2xl items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-900 dark:text-white">Edit Developer Profile</h1>
          <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">{dev.name} • {dev.role}</p>
        </div>
      </div>
