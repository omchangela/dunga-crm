...
import { MoreHorizontal, Eye, ChevronLeft, ChevronRight, FolderKanban } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-0.5 text-sm text-[#8094ae]">{projects.length} projects assigned</p>
      </div>
      ...
      <div className="overflow-hidden rounded-xl border border-[#e5e9f2] bg-white shadow-sm">
        ...
        {loading ? (
          ...
          <div className="py-16 text-center">
            ...
            <h3 className="mb-1 text-base font-semibold text-[#1a2035]">No projects assigned</h3>
            <p className="text-sm text-[#8094ae]">Projects assigned to you will appear here.</p>
          </div>
        ) : (
          <>
                    ...
                    return (
                      <tr key={p.id}
                        onClick={(e) => {
                          ...
                          router.push(`/developer/projects/${p.id}`);
                        }}
                          ...
                          {isOpen && (
                            <>
                              ...
                              <div className="absolute right-10 top-1/2 z-20 w-36 -translate-y-1/2 overflow-hidden rounded-xl border border-[#e5e9f2] bg-white py-1 shadow-lg">
                                <Link href={`/developer/projects/${p.id}`}
