...
export const sendDeveloperWelcomeEmail = async (opts: {
    email:    string
    name:     string
    password: string
    role:     string
    ...
    await transporter.sendMail({
        ...
        to:      email,
        subject: 'Welcome to Dunga Technologies — Developer Portal Access',
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">

                <div style="background: #3B7A82; padding: 20px 30px;">
                ...
                <div style="padding: 30px; background: #ffffff;
                    ...
                    <p style="color: #374151;">
                        ...
                        Here are your login credentials for the Developer Portal:
                    </p>

                    <div style="background: #f0f9fa; border-left: 4px solid #3B7A82;
                    ...
                    <p style="color: #6B7280; font-size: 13px;">
                        ...
                        You can access your projects, tasks, and profile from the portal.
                    </p>
